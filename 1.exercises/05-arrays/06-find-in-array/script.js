...
(() => {
    ...
    document.getElementById("run").addEventListener("click", () => {
        const found1 = people.find (element => element.lastname == "Dupont" && element.firstname == "Jean"); //i create a const who contain a function "find" who has a callback function who demand lastname AND firstname
        console.log(found1);
        alert(found1.email)
    })
})();
